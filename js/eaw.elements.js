...
eaw.Submarine = function (params){
  ...
  var ps;
  if (params.myPath === null){
    ps = "M 38.32,5.00 C 38.32,5.00 39.60,4.92 39.60,4.92 39.60,4.92 39.60,4.30 39.60,4.30 39.60,4.30 51.00,4.22 51.00,4.22 51.00,4.22 51.60,3.75 51.60,3.75 51.60,3.75 59.25,3.75 59.25,3.75 59.25,3.75 59.32,6.02 59.32,6.02 59.32,6.02 58.72,6.80 58.72,6.80 58.72,6.80 58.80,7.89 58.80,7.89 58.80,7.89 57.60,9.30 57.60,9.30 57.60,9.30 13.35,9.30 13.35,9.30 13.35,9.30 13.05,8.59 13.05,8.59 13.05,8.59 9.22,8.59 9.22,8.59 9.22,8.59 8.92,8.05 8.92,8.05 8.92,8.05 6.08,7.97 6.08,7.97 6.08,7.97 5.47,7.42 5.47,7.42 5.47,7.42 0.60,7.34 0.60,7.34 0.60,7.34 0.60,5.70 0.60,5.70 0.60,5.70 4.27,5.70 4.27,5.70 4.27,5.70 4.72,5.00 4.72,5.00 4.72,5.00 12.82,5.00 12.82,5.00 12.82,5.00 12.75,4.30 12.75,4.30 12.75,4.30 13.50,4.30 13.50,4.30 13.50,4.30 13.57,5.00 13.57,5.00 13.57,5.00 32.92,5.08 32.92,5.08 32.92,5.08 33.07,3.91 33.07,3.91 33.07,3.91 34.20,3.83 34.20,3.83 34.20,3.83 34.95,3.12 34.95,3.12 34.95,3.12 34.80,0.39 34.80,0.39 34.80,0.39 35.40,0.23 35.40,0.23 35.40,0.23 35.40,2.34 35.40,2.34 35.40,2.34 37.05,2.42 37.05,2.42 37.05,2.42 37.12,1.02 37.12,1.02 37.12,1.02 37.73,1.09 37.73,1.09 37.73,1.09 37.65,2.42 37.65,2.42 37.65,2.42 38.40,2.34 38.40,2.34 38.40,2.34 38.32,5.31 38.32,5.31";
    //"M 63.88,8.00 C 63.88,8.00 66.00,7.88 66.00,7.88 66.00,7.88 66.00,6.88 66.00,6.88 66.00,6.88 85.00,6.75 85.00,6.75 85.00,6.75 86.00,6.00 86.00,6.00 86.00,6.00 98.75,6.00 98.75,6.00 98.75,6.00 98.88,9.62 98.88,9.62 98.88,9.62 97.88,10.88 97.88,10.88 97.88,10.88 98.00,12.62 98.00,12.62 98.00,12.62 96.00,14.88 96.00,14.88 96.00,14.88 22.25,14.88 22.25,14.88 22.25,14.88 21.75,13.75 21.75,13.75 21.75,13.75 15.38,13.75 15.38,13.75 15.38,13.75 14.88,12.88 14.88,12.88 14.88,12.88 10.12,12.75 10.12,12.75 10.12,12.75 9.12,11.88 9.12,11.88 9.12,11.88 1.00,11.75 1.00,11.75 1.00,11.75 1.00,9.12 1.00,9.12 1.00,9.12 7.12,9.12 7.12,9.12 7.12,9.12 7.88,8.00 7.88,8.00 7.88,8.00 21.38,8.00 21.38,8.00 21.38,8.00 21.25,6.88 21.25,6.88 21.25,6.88 22.50,6.88 22.50,6.88 22.50,6.88 22.62,8.00 22.62,8.00 22.62,8.00 54.88,8.12 54.88,8.12 54.88,8.12 55.12,6.25 55.12,6.25 55.12,6.25 57.00,6.12 57.00,6.12 57.00,6.12 58.25,5.00 58.25,5.00 58.25,5.00 58.00,0.62 58.00,0.62 58.00,0.62 59.00,0.38 59.00,0.38 59.00,0.38 59.00,3.75 59.00,3.75 59.00,3.75 61.75,3.88 61.75,3.88 61.75,3.88 61.88,1.62 61.88,1.62 61.88,1.62 62.88,1.75 62.88,1.75 62.88,1.75 62.75,3.88 62.75,3.88 62.75,3.88 64.00,3.75 64.00,3.75 64.00,3.75 63.88,8.50 63.88,8.50";
    }
  else{
    eaw.Battleshipps = params.myPath;
  }
...
Zone.prototype.checkOwnerStatus = function(){
  ...
  else if (this.axis_count === 0 && this.ally_count === 0 && this.russia_count === 0){
    this.el.attr({stroke: 'black', 'stroke-width': 1});
  }

  else {
      for (var prop in this){
        if (prop.slice(-8) === 'unit_set'){
          var country_id = prop.substring(0,2);
          console.log('Present: ' + prop + ' ' + country_id);
          console.log(this[prop]);
/* This works in terms of firing, but the logic is terrible
          if (country_id !== this.current_owner && country_id !== this.original_owner){
            console.log('Conquered');
            this.current_owner = country_id;
            //conquered!
            this.el.attr({stroke: 'green', 'stroke-width': 6});
          }
*/
